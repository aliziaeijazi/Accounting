...
namespace AccountingApp {
    ...
    public partial class Accounting_DBDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CustomersRow AddCustomersRow(string Name, string Family, string PhoneNumber, string Email, string Address, string CustomerImage) {
...
namespace AccountingApp.Accounting_DBDataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Customers] WHERE (([CustomerID] = @Original_CustomerID) AND ([Name] = @Original_Name) AND ([Family] = @Original_Family) AND ([PhoneNumber] = @Original_PhoneNumber) AND ([Email] = @Original_Email) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ([CustomerImage] = @Original_CustomerImage))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Customers] ([Name], [Family], [PhoneNumber], [Email], [Address], [CustomerImage]) VALUES (@Name, @Family, @PhoneNumber, @Email, @Address, @CustomerImage);
SELECT CustomerID, Name, Family, PhoneNumber, Email, Address, CustomerImage FROM Customers WHERE (CustomerID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customers] SET [Name] = @Name, [Family] = @Family, [PhoneNumber] = @PhoneNumber, [Email] = @Email, [Address] = @Address, [CustomerImage] = @CustomerImage WHERE (([CustomerID] = @Original_CustomerID) AND ([Name] = @Original_Name) AND ([Family] = @Original_Family) AND ([PhoneNumber] = @Original_PhoneNumber) AND ([Email] = @Original_Email) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ([CustomerImage] = @Original_CustomerImage));
SELECT CustomerID, Name, Family, PhoneNumber, Email, Address, CustomerImage FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::AccountingApp.Properties.Settings.Default.Accounting_DBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerID, Name, Family, PhoneNumber, Email, Address, CustomerImage FROM " +
                "dbo.Customers";
        ...
        public virtual int Delete(int Original_CustomerID, string Original_Name, string Original_Family, string Original_PhoneNumber, string Original_Email, string Original_Address, string Original_CustomerImage) {
        ...
        public virtual int Insert(string Name, string Family, string PhoneNumber, string Email, string Address, string CustomerImage) {
            if ((Name == null)) {
            ...
            if ((CustomerImage == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[5].Value = ((string)(CustomerImage));
            }
        ...
        public virtual int Update(string Name, string Family, string PhoneNumber, string Email, string Address, string CustomerImage, int Original_CustomerID, string Original_Name, string Original_Family, string Original_PhoneNumber, string Original_Email, string Original_Address, string Original_CustomerImage, int CustomerID) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
            ...
            if ((CustomerImage == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(CustomerImage));
            }
            ...
            if ((Original_CustomerImage == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((string)(Original_CustomerImage));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Family, string PhoneNumber, string Email, string Address, string CustomerImage, int Original_CustomerID, string Original_Name, string Original_Family, string Original_PhoneNumber, string Original_Email, string Original_Address, string Original_CustomerImage) {
            return this.Update(Name, Family, PhoneNumber, Email, Address, CustomerImage, Original_CustomerID, Original_Name, Original_Family, Original_PhoneNumber, Original_Email, Original_Address, Original_CustomerImage, Original_CustomerID);
        }
    }
